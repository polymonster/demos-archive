...
struct SVector3
{
	...
	SVector3 &operator+=(SVector3 vector) {x += vector.x, y += vector.y, z += vector.z; return *this;};
...
void SPHEREVSBOXTOPS(SVector3 boxPos,SVector3 boxScale,SVector3 boxOrientation,
					float radius,SVector3 ballPos,SVector3 *offsets,bool *edge);
...
SMatrix4x4 matrixMultiplication(SMatrix4x4 rhs,SMatrix4x4 lhs);
