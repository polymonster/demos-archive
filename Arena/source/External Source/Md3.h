...
public:
	...
	void SetNextTorsoAnimation(LPSTR strAnimation);
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
	...
	SVector3 bulletStartPos;

	bool jumpComplete;

	float muzzleMatrix[16];
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
	...
	void DrawLink(t3DModel *pModel,bool doxrot,float xrot);
