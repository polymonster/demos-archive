	...
	m_menu_state( MENU_STATE_SLIDEON )
{
	...
	g_sound_mgr_p->load("sound/sfx/BULLET.wav",false);
	g_sound_mgr_p->load("sound/sfx/MISSILE.wav",false);
	g_sound_mgr_p->load("sound/sfx/BEAM.wav",false);
	g_sound_mgr_p->load("sound/sfx/COLLECT.wav",false);
	g_sound_mgr_p->load("sound/sfx/EXPLODE.wav",false);
	g_sound_mgr_p->load("sound/sfx/EXPLODE2.wav",false);
	g_sound_mgr_p->load("sound/sfx/ACTIVATE.wav",false);
	g_sound_mgr_p->load("sound/sfx/OPEN.wav",false);
	g_sound_mgr_p->load("sound/sfx/CLOSE.wav",false);
	g_sound_mgr_p->load("sound/sfx/INMOTION.wav",false);
	g_sound_mgr_p->load("sound/sfx/STOP.wav",false);
	g_sound_mgr_p->load("sound/sfx/DEATH.wav",false);
	g_sound_mgr_p->load("sound/sfx/START.wav",false);
	g_sound_mgr_p->load("sound/sfx/JUMP1.wav",false);
	g_sound_mgr_p->load("sound/sfx/JUMP2.wav",false);
	g_sound_mgr_p->load("sound/sfx/JUMPLAND.wav",false);
	g_sound_mgr_p->load("sound/sfx/RESPAWN.wav",false);
	g_sound_mgr_p->load("sound/sfx/SAVE.wav",false);
	g_sound_mgr_p->load("sound/sfx/INTERACT.wav",false);

	g_sound_mgr_p->play(S_START,25);
