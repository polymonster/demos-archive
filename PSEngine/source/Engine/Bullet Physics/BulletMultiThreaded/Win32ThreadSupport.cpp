...
void Win32ThreadSupport::startThreads(const Win32ThreadConstructionInfo& threadConstructionInfo)
{
	...
	for (int i=0;i<threadConstructionInfo.m_numThreads;i++)
	{
		...
		spuStatus.m_eventStartHandle = CreateEvent(0,false,false,(LPCWSTR) spuStatus.m_eventStartHandleName);

		sprintf(spuStatus.m_eventCompletetHandleName,"eventComplete%s%d",threadConstructionInfo.m_uniqueName,i);
		spuStatus.m_eventCompletetHandle = CreateEvent(0,false,false,(LPCWSTR) spuStatus.m_eventCompletetHandleName);
