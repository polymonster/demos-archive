...
#define VEC_IMPACT_SQ(bsq,m_caster_direction,position) {\
   GREAL _llel_ = VEC_DOT(m_caster_direction, position);\
   bsq = VEC_DOT(position, position) - _llel_*_llel_;\
}\


/// vector impact parameter
#define VEC_IMPACT(bsq,m_caster_direction,position)	{\
   VEC_IMPACT_SQ(bsq,m_caster_direction,position);		\
   GIM_SQRT(bsq,bsq);					\
}\
